...
describe("filter", function () {
  describe("isProfane", function () {
    ...
    it("Should detect a bad word and return a boolean value escaping special characters", function () {
      assert(filter.isProfane("ásh0le"));
    });
    ...
    it("Should detect bad word phrases with special characters", function () {
      filter.addWords("óh nó");
      assert(filter.isProfane("óh nó this is profane!"));
    });
  });
});
